...
import { SaveStudentToDBUsingFetch, SaveUserToDB, getStudentsFromDB } from "../../state/Student/studentAction";
    ...
    return (
        ...
        <section  className={"componentClass"}>
            ...
            <div className="form col-md-8">
                ...
                <input type="text" className="form-control col-md-6 studentName" 
                    ...
                    placeholder="Student Name" onChange={(evt)=>setStudentName(evt.target.value)} maxLength={40}/>
                </div>
                <div className="col-md-12">
                <b>Age: </b>
                <input type="number" className="form-control col-md-6 age" 
                        value={age} //state to update the userName
                    placeholder="Age" onChange={(evt)=>setAge(evt.target.value)}maxLength={40}/>
                </div>
                <div className="col-md-12">
                <b>Address: </b>
                <input type="text" className="form-control col-md-6 address" 
                        value={address} //state to update the userName
                    placeholder="Address" onChange={(evt)=>setAddress(evt.target.value)} maxLength={40}/>
                </div>
                <div className="col-md-12">
                <b>Mobile: </b>
                <input type="number" className="form-control col-md-6 mobile" 
                        value={mobile} //state to update the userName
                    placeholder="Mobile" onChange={(evt)=>setMobile(evt.target.value)} maxLength={40}/>
                </div>
        ...
        <section  className={"componentClass"}>
            ...
            <div className="form col-md-8">
                ...
                <input type="button" className={"btn btn-primary col-md-2 getStudent"} 
                                    value={"get Students"} 
